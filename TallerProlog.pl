%Se definen hechos para un árbol
%familiar
%
...
%Una regla para hermanDe(X,Y), sería
%
hermanaDe(X,W):-
    mujer(X),
    padres(X,Y,Z),
...
%Hechos para la función miembro.
%
miembro(X,[X|_]).
miembro(X,[_|Z]):-
    miembro(X,Z).

%Hechos para la función inversa.
%
...
%Acontecimientos
acontecimiento(1943,"En el 1943 se publicó El Principito").
acontecimiento(2007,"En el 2007 se publicó El Nombre del Viento").
acontecimiento(1902,"En el 1902 se publicó El perro de los Baskerville").
